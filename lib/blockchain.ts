// Generated by @wagmi/cli@0.1.3 on 2/1/2023 at 2:56:08 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link pixelUniverseABI}__ and `functionName` set to `"mint"`.
 */
export function usePixelUniverseMint<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof pixelUniverseABI, 'mint'>['abi'], 'mint'> & { functionName?: 'mint' }
    : UseContractWriteConfig<TMode, typeof pixelUniverseABI, 'mint'> & {
        abi?: never
        functionName?: 'mint'
      } = {} as any
) {
  return useContractWrite<TMode, typeof pixelUniverseABI, 'mint'>({ abi: pixelUniverseABI, functionName: 'mint', ...config } as any)
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link pixelUniverseABI}__ and `functionName` set to `"mint"`.
 */
export function usePreparePixelUniverseMint(
  config: Omit<UsePrepareContractWriteConfig<typeof pixelUniverseABI, 'mint'>, 'abi' | 'functionName'> = {} as any
) {
  return usePrepareContractWrite({ abi: pixelUniverseABI, functionName: 'mint', ...config } as UsePrepareContractWriteConfig<
    typeof pixelUniverseABI,
    'mint'
  >)
}
