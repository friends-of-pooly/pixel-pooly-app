...
const optionsHead = [
  ...
  },
  {
    ...
    svg: '/img/pixel-pooly-assets/SVG/beta/2-head/head-OPeyes.svg',
  },
  {
    tier: 1,
    layer: 2,
...
const optionsBodyLower = [
  ...
  },
  {
    ...
    expiry: 0,
    traitName: 'Sitting',
    traitDescription: 'Pooly has walked in many others shoes, take a load off.',
...
const optionsHeadAcc = [
  ...
  },
  {
    ...
    svg: '/img/pixel-pooly-assets/SVG/beta/6-headAcc/hatAcc-gigabrain.svg',
  },
  {
    tier: 2,
    layer: 6,
    ...
    svg: '/img/pixel-pooly-assets/SVG/beta/6-headAcc/hatAcc-king.svg',
  },
  {
    tier: 1,
    layer: 6,
    ...
    stats: [{ categoryType: 'defense', value: 2 }],
    svg: '/img/pixel-pooly-assets/SVG/beta/6-headAcc/hatAcc-egghead.svg',
  },
  {
    tier: 1,
    layer: 6,
...
const optionsBodyAcc = [
  ...
  },
  {
    ...
    frame: 5,
    expiry: 0,
    traitName: 'Black FoP Shirt',
    traitDescription: 'Welcome to the inner circle of Friends of Pooly.',
    stats: [
      { categoryType: 'constitution', value: 2 },
      { categoryType: 'wisdom', value: 1 },
    ],
    svg: '/img/pixel-pooly-assets/SVG/beta/8-bodyAcc/bodyAcc-FoPshirt-black.svg',
  },
  {
    tier: 1,
    layer: 8,
    frame: 6,
    expiry: 0,
    traitName: 'Navy FoP Shirt',
    traitDescription: 'Welcome to the inner circle of Friends of Pooly.',
    stats: [
      { categoryType: 'constitution', value: 2 },
      { categoryType: 'wisdom', value: 1 },
    ],
    svg: '/img/pixel-pooly-assets/SVG/beta/8-bodyAcc/bodyAcc-FoPshirt-navy.svg',
  },
  {
    tier: 1,
    layer: 8,
    frame: 7,
    expiry: 0,
    traitName: 'Red FoP Shirt',
    traitDescription: 'Welcome to the inner circle of Friends of Pooly.',
    stats: [
      { categoryType: 'constitution', value: 2 },
      { categoryType: 'wisdom', value: 1 },
    ],
    svg: '/img/pixel-pooly-assets/SVG/beta/8-bodyAcc/bodyAcc-FoPshirt-red.svg',
  },
  {
    tier: 1,
    layer: 8,
    ...
    svg: '/img/pixel-pooly-assets/SVG/beta/8-bodyAcc/bodyAcc-OPshirt.svg',
  },
  {
    tier: 2,
    layer: 8,
...
const optionsBodyLowerAcc = [
  {
    ...
    expiry: 0,
    traitName: 'None',
    traitDescription: 'Pooly pets and more are coming.',
    stats: [],
    svg: '',
  },
];
...
const optionsLeftWingAcc = [
  ...
  },
  {
    ...
    svg: '/img/pixel-pooly-assets/SVG/beta/10-leftWingAcc/leftWingAcc-cane.svg',
  },
  {
    tier: 1,
    layer: 10,
    ...
    svg: '/img/pixel-pooly-assets/SVG/beta/10-leftWingAcc/leftWingAcc-defendershield.svg',
  },
  {
    tier: 2,
    layer: 10,
...
const optionsRightWingAcc = [
  ...
  },
  {
    ...
    svg: '/img/pixel-pooly-assets/SVG/beta/11-rightWingAcc/rightWingAcc-cane.svg',
  },
  {
    tier: 1,
    layer: 11,
    ...
    svg: '/img/pixel-pooly-assets/SVG/beta/11-rightWingAcc/rightWingAcc-defendershield.svg',
  },
  {
    tier: 2,
    layer: 11,
